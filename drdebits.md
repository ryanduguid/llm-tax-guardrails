...
The [10 September 2026 update to TPB(GS) 43/2023](https://www.tpb.gov.au/tpb-gs-43-2023-what-is-bas-service) describes additional BAS services using the history of the *Tax Agent Services (Specified BAS Services No. 2) Instrument 2020*. The instrument was [repealed from 7 July 2026](https://www.legislation.gov.au/F2026L00916/asmade/details). Its historical mention does not make it operative: classify the service under the applicable TASA s 90-10, including subsections (1AA) and (1AB). This source update postdates the guide-wide source check and is labelled `SOURCE CURRENCY NOT CONFIRMED`: do not rely on this mapping or make a current-law claim from it until a competent human has reviewed it, and escalate where the classification turns on it. The guide-wide source-check date has not advanced.

Schedule 1 to the [*Treasury Laws Amendment (Strengthening Accountability for Tax Adviser Misconduct and Other Measures) Act 2026*](https://www.legislation.gov.au/C2026A00086/asmade) and the [*Tax Agent Services (Code of Professional Conduct) Amendment (Enhancing Tax Practitioners Board Sanctions) Determination 2026*](https://www.legislation.gov.au/F2026L01196/asmade) amend TASA and the Code Determination from 1 October 2026, for conduct and events on or after that date. The compilations pinned above predate both. Among other changes, the TPB may suspend registration, a failure to comply with the Code becomes a civil penalty provision (TASA s 50-31), unregistered providers face new criminal offences and civil penalties, Code Determination s 45 gains disclosure events and timing, and a s 15(2) notification must identify the client and the statement. For conduct or events from 1 October 2026, label the affected controls `SOURCE CURRENCY NOT CONFIRMED` until a competent human has reviewed the compiled text.
...
- distinguish the client's penalty relief from any separate practitioner consequences; s 284-75(6) does not transfer the client's penalty to the agent. Record the client's evidential burden under s 284-75(7) for supplying all relevant taxation information. Flag incomplete information, possible agent recklessness or intentional disregard, and the statutory exclusion concerning the Excise Acts for authorised human review. The LLM MUST NOT conclude that the safe harbour applies, advise reliance on it, or assess an agent’s culpability.
...
- flag the enrolment clock under s 51B of the Act: a person whose name is not on the Reporting Entities Roll, and to whom s 51B(2) or (2A) does not apply, must apply to enrol with AUSTRAC no later than 28 days after the day the person commences to provide a designated service. [Schedule 3, item 12 of the 2024 amending Act](https://www.legislation.gov.au/C2024A00110/asmade/text) substitutes 29 July 2026 for a person who provides, or commences to provide, a designated service covered by item 2 of table 2, or an item of table 5 or 6, at any time before 1 July 2026 and who does not, as at that time, provide, or commence to provide, any other designated services. Verify both conditions and the operative provisions for the relevant date
