...
- flag the enrolment clock under s 51B of the Act: a reporting entity must apply to enrol with AUSTRAC within 28 days of starting to provide a designated service. [Schedule 3, item 12 of the 2024 amending Act](https://www.legislation.gov.au/C2024A00110/asmade/text) substitutes 29 July 2026 for persons who provided a service covered by table 2 item 2, table 5 or table 6 before 1 July 2026 and did not then provide any other designated services. Verify those conditions and the operative provisions for the relevant date;
